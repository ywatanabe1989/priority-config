#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-08-02 19:21:40 (ywatanabe)"
# File: /home/ywatanabe/proj/priority_config/priority_config.py
# ----------------------------------------
from __future__ import annotations
import os
__FILE__ = (
    "./priority_config/priority_config.py"
)
...
class PriorityConfig:
    ...
    # Usage examples:
    # Django-style
    django_config = PriorityConfig(config_dict={}, env_prefix="DJANGO_", auto_uppercase=True)
    debug = django_config.resolve("debug", direct_debug, default=False, type=bool)

    # Custom app
    app_config = PriorityConfig(yaml_data, "MYAPP_")
    ...
    # No prefix
    simple_config = PriorityConfig(config_data, "")
